...
cards.innerHTML = resources
	.map(
		(card) =>
			`
   	<article class="rounded-lg border bg-white  hover:bg-gray-100 dark:bg-primary dark:border-gray-700 dark:hover:bg-gray-800 cursor-pointer p-4 shadow-sm transition hover:shadow-lg sm:p-5">
         ...
         <p class="mt-2 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
			...
			<button class='mt-2 text-blue-700 font-bold tracking-wider inline-flex items-center'>
				<span class='inline-flex items-center  space-x-2'>Read more</span>
				<span class='ml-2'><i class="uil uil-external-link-alt"></i></span>
			</button>
    	</article>
	`,
	)
